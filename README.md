This GitHub fork has been improved based on the official ["franka_description"](https://github.com/frankaemika/franka_description), the main improvements are related to `URDF` files including,
